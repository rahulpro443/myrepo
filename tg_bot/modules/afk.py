...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{}  Busy അണ്  ! ".format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} Busy alla അവൻ വന്നിട്ടുണ്ട്  !".format(update.effective_user.first_name))
